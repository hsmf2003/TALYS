...
\begin{figure}[H]
    ...
    \caption{Same diagnostic panels as in \cref{fig:benck-en28-p-diagnostics}, but for deuteron production on \ce{^{28}Si} using the Benck EXFOR dataset 22807.027 at $E_n=28.5$ MeV. The decomposition panel corresponds to the selected mode, \texttt{preeqmode=3}.}
...
\begin{figure}[H]
    ...
    \caption{Same diagnostic panels as in \cref{fig:benck-en28-p-diagnostics}, but for deuteron production on \ce{^{28}Si} using the Benck EXFOR dataset 22807.027 at $E_n=41.0$ MeV. The decomposition panel corresponds to the selected mode, \texttt{preeqmode=3}.}
...
\begin{figure}[H]
    ...
    \caption{Same diagnostic panels as in \cref{fig:benck-en28-p-diagnostics}, but for deuteron production on \ce{^{28}Si} using the Benck EXFOR dataset 22807.027 at $E_n=49.0$ MeV. The decomposition panel corresponds to the selected mode, \texttt{preeqmode=3}.}
...
\begin{figure}[H]
    ...
    \caption{Same diagnostic panels as in \cref{fig:benck-en28-p-diagnostics}, but for deuteron production on \ce{^{28}Si} using the Bateman EXFOR dataset 13740.006 at $E_n=28.0$ MeV. The decomposition panel corresponds to the selected mode, \texttt{preeqmode=4}.}
...
\begin{figure}[H]
    ...
    \caption{Same diagnostic panels as in \cref{fig:benck-en28-p-diagnostics}, but for deuteron production on \ce{^{28}Si} using the Bateman EXFOR dataset 13740.006 at $E_n=41.0$ MeV. The decomposition panel corresponds to the selected mode, \texttt{preeqmode=2}.}
...
\begin{figure}[H]
    ...
    \caption{Same diagnostic panels as in \cref{fig:benck-en28-p-diagnostics}, but for deuteron production on \ce{^{28}Si} using the Bateman EXFOR dataset 13740.006 at $E_n=49.0$ MeV. The decomposition panel corresponds to the selected mode, \texttt{preeqmode=1}.}
