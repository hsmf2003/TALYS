...
The fundamental concept for this study, and for interpreting the type of data produced by the reaction code TALYS, is the \emph{nuclear cross section}. Cross sections quantify reaction probabilities. One should note that the energy spectrum of the emitted particles is the differential cross section with respect to energy. For emission of a particle $b$ into a solid-angle element $d\Omega$, the differential cross section $d\sigma/d\Omega$ has units in barn/sr. When the outgoing energy $E_b$ is resolved, the relevant observable is the (double-)differential quantity
